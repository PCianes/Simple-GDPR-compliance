 ...
 */
class Simple_Gdpr_Compliance_Includes {
	...
	private function load_dependencies() {
		 ...
		 * example: require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-simple-gdpr-compliance-class-name.php';
		 * example: $class_name = new Simple_Gdpr_Compliance_Class_Name( $this->get_plugin_name(), $this->get_version() );
		 */
	}
